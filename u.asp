...
body {background-color:#ffffff;color:#000000;margin:0px;font-family:"\5fae\8f6f\96c5\9ed1","\9ed1\4f53", Tahoma, sans-serif;}
...
<table class="info tablex1">
  ...
  <tr>
    ...
    <td class="fl"><%=Request.ServerVariables("SERVER_PORT")%></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="er">HTTP接受语言</td>
    <td class="fl" style="word-break:break-all;word-wrap:break-word"><%=Request.ServerVariables("Http_Accept_Language")%></td>
  </tr>
<%
...
<table class="info tablex2">
 ...
 <p style="color:#505050;font-size:14px;text-align:center;clear:both; margin-bottom:20px;">&copy; <%=Year(now())%> <a href="http://www.upupw.net" target="_blank">UPUPW ASP探针</a>，站点内容与本程序无关。</p>
</div>
</body>
</html>
